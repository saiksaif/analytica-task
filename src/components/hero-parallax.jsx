...
export const ProductCard = ({ product, translate }) => {
  return (
    ...
    >
      <a
        href={product.link}
        className="block group-hover/product:shadow-2xl boredr border-red-500"
      >
        <img
          src={product.thumbnail}
          className="object-cover object-top absolute h-[600px] w-[600px]"
          alt={product.title}
        />
      </a>
